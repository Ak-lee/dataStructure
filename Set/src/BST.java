...
public class BST<E extends Comparable<E>> {
    ...
    // 返回插入新节点后二分搜索树的根
    // null 空本身也是1颗二叉树，若 node 为null，用e生成新节点并返回，在此次函数调用处赋值
    ...
    private Node remove(Node node, E e) {
        ...
        if(e.compareTo(node.e)<0) {
            ...
            successor.right = removeMin(node.right);    // removeMin 中已经进行了一次 size--
    ...
    // 生成以node为根节点，深度为 depth 的描述二叉树的字符串
